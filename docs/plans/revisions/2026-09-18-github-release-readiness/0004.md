...
change_control:
  mode: adaptive
content_hash: sha256:e068eb28fb19f5364dfb087cb6ca490f3e8cb095553e97085da95d2e098e9765
context_pages: []
...
last_writer: Owner (chat approval)
owner: agent
...
updated_at: '2026-09-18T11:37:04Z'
---
# Goal
...
|---|---|---|---|---|---|---|---|---|
| 1 | B1 | Rewrite English and Simplified Chinese READMEs with current capabilities, source-only instructions, equivalent structure, one architecture view, and one usage flow view | none | medium | README.md, README.zh-CN.md, tests/test_execution_quality.py | none | unit-tests gate T-001 | pending |
