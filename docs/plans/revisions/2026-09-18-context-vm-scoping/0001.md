...
change_control:
  mode: adaptive
content_hash: sha256:2c2e0f805cd894090630f71096bd7a88c538637c729675d40a4b74769c8db05f
context_pages: []
...
testing:
  ...
  tests:
  - batch: B1
    behavior: 'Verify the first task: Context Vm Scoping.'
    disposition: implement
    files:
    - tests/test_context_vm_scoping.py::test_first_task
    gate_id: unit-tests
    kind: unit
    task: 1
    test_id: T-001
