...
change_control:
  mode: adaptive
content_hash: sha256:9dcc0484cbe5c01937a455e9e531f127090cbf2d04b9f62699a4f9464e1e761e
context_pages: []
...
updated_at: '2026-09-18T12:09:00Z'
---
# Goal
...
|---|---|---|---|---|---|---|---|---|
| 1 | B1 | Rewrite English and Simplified Chinese READMEs with current capabilities, source-only instructions, equivalent structure, one architecture view, and one usage flow view | none | medium | README.md, README.zh-CN.md, tests/test_execution_quality.py | none | unit-tests gate T-001 | in-progress |
...
|---|---|---|---|---|
| B1 | Bilingual README refresh | none | in-progress |  |
| B2 | GitHub metadata and community files | B1 | stale |  |
