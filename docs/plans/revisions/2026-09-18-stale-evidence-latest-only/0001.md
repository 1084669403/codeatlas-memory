...
change_control:
  mode: adaptive
content_hash: sha256:a9591952063fa7c4d977266f5792aa4e647727569bffd800d6ac7eba91c5f207
context_pages: []
...
testing:
  ...
  tests:
  - batch: B1
    behavior: 'Verify the first task: Stale Evidence Latest Only.'
    disposition: implement
    files:
    - tests/test_stale_evidence_latest_only.py::test_first_task
    gate_id: unit-tests
    kind: unit
    task: 1
    test_id: T-001
